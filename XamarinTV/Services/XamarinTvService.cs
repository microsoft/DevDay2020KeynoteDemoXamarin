...
{
    public class XamarinTvService
    {
        static readonly Lazy<XamarinTvService> _instance = new Lazy<XamarinTvService>(() => new XamarinTvService());

        public static XamarinTvService Instance => _instance.Value;
        ...
        public async Task<IEnumerable<VideoGroup>> GetVideoGroupsAsync()
        {
            await Task.Delay(500);
